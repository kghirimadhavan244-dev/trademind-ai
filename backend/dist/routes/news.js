...
router.get("/", async (_req, res) => {
    try {
        ...
        const response = await axios_1.default.get(`https://newsapi.org/v2/top-headlines?country=in&category=business&pageSize=10&apiKey=${apiKey}`);
        ...
        console.warn("⚠️ [News Fallback] Error loading external news. Serving Indian mock financial news:", error.message);
        return res.json({
            success: true,
            articles: mockIndianNews,
        });
