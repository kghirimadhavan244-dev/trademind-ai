          ...
          {token ? (
            ...
            <>
              <Link
                to="/login"
                onClick={() => setMobileMenuOpen(false)}
                className="text-slate-600 dark:text-slate-300 py-2.5 hover:text-blue-600 font-bold text-sm border-b border-slate-100 dark:border-slate-800/50"
              >
                Login
              </Link>
              <Link
                to="/signup"
                onClick={() => setMobileMenuOpen(false)}
                className="text-slate-600 dark:text-slate-300 py-2.5 hover:text-blue-600 font-bold text-sm"
              >
                Create Account
              </Link>
            </>
